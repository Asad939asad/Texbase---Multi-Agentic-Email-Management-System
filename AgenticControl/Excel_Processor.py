...
if __name__ == "__main__":
    ...
    # =========================================================
    # PHASE 1: RUN EMAIL SPECIFIC PIPELINE
    # =========================================================
    ...
    if valid_states:
        ...
        # =========================================================
        # PHASE 2: RUN EXCEL PROCESSOR & DATABASE INSERTION
        # =========================================================
        print("\n  Triggering Excel Processor pipeline...")
        init_db()
        
        # Point the processor directly to the file just generated by Phase 1
        excel_path_to_process = Path(EXCEL_OUTPUT) 
        
        if os.path.exists(excel_path_to_process):
            process_excel(excel_path_to_process)
        else:
            print(f"❌ File not found: {excel_path_to_process}")

    else:
        print("\n  No companies processed (queue may be empty). Skipping DB insertion.")